...
class AddComponent<T: NumericComponent, K: NumericComponent>: BinopAbstract<T, K> where T.Raw == K.Raw {
    var desc: String { "+" }
}
...
class SubComponent<T: NumericComponent, K: NumericComponent>: BinopAbstract<T, K> where T.Raw == K.Raw {
    var desc: String { "-" }
}
...
class MulComponent<T: NumericComponent, K: NumericComponent>: BinopAbstract<T, K> where T.Raw == K.Raw {
    var desc: String { "*" }
}
...
class DivComponent<T: NumericComponent, K: NumericComponent>: BinopAbstract<T, K> where T.Raw == K.Raw {
    var desc: String { "/" }
}
